...
/* @var $searchModel backend\models\AssetgroupSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'กลุ่มเครื่องจักร');
...
<div class="assetgroup-index">
    ...
    <div class="x_panel">
        <div class="x_title">
            <div class="btn-group">
                <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> สร้างกลุ่มเครื่องจักร'), ['create'], ['class' => 'btn btn-success']) ?>
            </div>
