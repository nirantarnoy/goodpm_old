...
/* @var $searchModel backend\models\WorktradeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Worktrades');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="worktrade-index">
    ...
    <div class="x_panel">
        <div class="x_title">
            <div class="btn-group">
                <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> สร้างหน่วยงานดูแล'), ['create'], ['class' => 'btn btn-success']) ?>
            </div>
